(function () {
  ...
  function _defineTogoKeys2(_ref3) {
    ...
    _classPrivateFieldGet(this, _TOGO_KEYS).value = ConditionBuilder$1.currentDataset;
    // attach event
  ...
  function _addAnnotation2(conditionAnnotation) {
    // modifier
    _classPrivateFieldGet(this, _PROPERTIES_CONDITIONS_CONTAINER).classList.remove('-empty');
    // make view
  ...
  function _addFilter2(attributeId, node) {
    // modifier
    _classPrivateFieldGet(this, _ATTRIBUTES_CONDITIONS_CONTAINER).classList.remove('-empty');
