(function () {
  ...
  var _stanza2 = function _stanza2(subjectId, value) {
    ...
    function TableData(condition, elm) {
      ...
      _classPrivateFieldGet(this, _BUTTON_PREPARE_DOWNLOAD).addEventListener('click', function (e) {
        ...
        if (_classPrivateFieldGet(_this, _isAutoLoad) == false && _classPrivateFieldGet(_this, _ROOT$5).dataset.status != 'complete') {
          ...
          _classPrivateFieldGet(_this, _BUTTON_PREPARE_DOWNLOAD).querySelector(':scope > .prepare-data').innerHTML = 'stop';
        } else {
          ...
          _classPrivateFieldGet(_this, _BUTTON_PREPARE_DOWNLOAD).querySelector(':scope > .prepare-data').innerHTML = 'prepare data';
        }
      }); // delete button
      ...
      BUTTONS.find(function (button) {
        ...
        e.stopPropagation();
        console.log('restore');
        console.log(_classPrivateFieldGet(_this, _condition).attributes);
  ...
  var _defineTogoKeys2$1 = function _defineTogoKeys2(togoKeys) {
